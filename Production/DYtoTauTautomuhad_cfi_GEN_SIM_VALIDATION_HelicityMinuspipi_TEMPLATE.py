...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
					...
					fileName = cms.untracked.string('DYtoTauTautomuhad_HadHelicityMinus_Gen_SIM_genvalid_all.root'),
...
process.MuFilter = cms.EDFilter("PythiaFilter",
    ...
    MinPt = cms.untracked.double(14.5),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
		...
		Tauolapp114 = cms.untracked.PSet(
			...
			doHelicityHadFilter = cms.untracked.bool(True),
			doHelicityLepFilter = cms.untracked.bool(False),
			hadHelicity = cms.untracked.int32(-1),
			lepHelicity = cms.untracked.int32(1),
			doHadPtFilter = cms.untracked.bool(True),
			...
			setTauBr = cms.PSet(
				JAK = cms.vint32(1, 2, 3, 4, 5, 
						 ...
						 16, 17, 18, 19, 20, 
						 21, 22),
				BR = cms.vdouble(0.0, 0.1741, 0.1, 0.0, 0.1832, 
...
process.generation_step = cms.Path(process.pgen+process.MuFilter)
