...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
	    ...
	    doHadPtFilter = cms.untracked.bool(False),
	    doLepPtFilter = cms.untracked.bool(False),
	    hadPt = cms.untracked.double(18),
	    lepPt = cms.untracked.double(15),
	    NFilterTests  = cms.untracked.int32(1000),
            InputCards = cms.PSet(
                mdtau = cms.int32(0),
                pjak2 = cms.int32(2),
                pjak1 = cms.int32(3)
            ...
            setTauBr = cms.PSet(
                JAK = cms.vint32(1, 2, 3, 4, 5, 
                    ...
                    16, 17, 18, 19, 20, 
                    21, 22),
                BR = cms.vdouble(0.0, 0.1741, 0.1832, 0.0, 0.0, #0.1832, 
