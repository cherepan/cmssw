...
void PhotosppInterface::init(){
  ...
  for (unsigned int ip=0; ip<par.size(); ++ip ){
    ...
    if(curSet=="setQuatroBrem")                    Photospp::Photos::setQuatroBrem(fPSet->getParameter<bool>(curSet));
    if(curSet=="setExponentiation")                Photospp::Photos::setExponentiation(fPSet->getParameter<bool>(curSet));
    if(curSet=="setCorrectionWtForW")              Photospp::Photos::setCorrectionWtForW(fPSet->getParameter<bool>(curSet));
    if(curSet=="setMeCorrectionWtForScalar")       Photospp::Photos::setMeCorrectionWtForScalar(fPSet->getParameter<bool>(curSet));
    if(curSet=="setMeCorrectionWtForW")            Photospp::Photos::setMeCorrectionWtForW(fPSet->getParameter<bool>(curSet));
    if(curSet=="setMeCorrectionWtForZ")            Photospp::Photos::setMeCorrectionWtForZ(fPSet->getParameter<bool>(curSet));
    if(curSet=="initializeKinematicCorrections")   Photospp::Photos::initializeKinematicCorrections(fPSet->getParameter<int>(curSet));
    if(curSet=="forceMassFrom4Vector")             Photospp::Photos::forceMassFrom4Vector(fPSet->getParameter<bool>(curSet));
    if(curSet=="forceMassFromEventRecord")         Photospp::Photos::forceMassFromEventRecord(fPSet->getParameter<int>(curSet));
    if(curSet=="ignoreParticlesOfStatus")          Photospp::Photos::ignoreParticlesOfStatus(fPSet->getParameter<int>(curSet));
  ...
  // Now setup more complicated radiation/mass supression and forcing.
	...
	std::string vs = v[i];
	std::vector<int> vpar = cfg.getParameter<std::vector<int> >(vs);
        if(vpar.size()==1)  Photospp::Photos::suppressBremForDecay(0,vpar[0]);
        if(vpar.size()==2)  Photospp::Photos::suppressBremForDecay(0/*vpar[0]*/,vpar[1]);
        if(vpar.size()==3)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2]);
        if(vpar.size()==4)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3]);
        if(vpar.size()==5)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4]);
        if(vpar.size()==6)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5]);
        if(vpar.size()==7)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6]);
        if(vpar.size()==8)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7]);
        if(vpar.size()==9)  Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7],vpar[8]);
        if(vpar.size()==10) Photospp::Photos::suppressBremForDecay(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7],vpar[8],vpar[9]);
      }
    }
	...
	std::string vs = v[i];
	std::vector<int> vpar = cfg.getParameter<std::vector<int> >(vs);
	if(vpar.size()==1)  Photospp::Photos::forceBremForBranch(0,vpar[0]);
	if(vpar.size()==2)  Photospp::Photos::forceBremForBranch(0/*vpar[0]*/,vpar[1]);
	if(vpar.size()==3)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2]);
	if(vpar.size()==4)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3]);
	if(vpar.size()==5)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4]);
	if(vpar.size()==6)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5]);
	if(vpar.size()==7)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6]);
	if(vpar.size()==8)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7]);
	if(vpar.size()==9)  Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7],vpar[8]);
	if(vpar.size()==10) Photospp::Photos::forceBremForBranch(vpar[0],vpar[1],vpar[2],vpar[3],vpar[4],vpar[5],vpar[6],vpar[7],vpar[8],vpar[9]);
      }
    }
