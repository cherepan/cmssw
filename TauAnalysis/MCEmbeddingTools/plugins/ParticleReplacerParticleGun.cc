#include "TauAnalysis/MCEmbeddingTools/plugins/ParticleReplacerParticleGun.h"
...
DEFINE_EDM_PLUGIN(ParticleReplacerPluginFactory, ParticleReplacerParticleGun, "ParticleReplacerParticleGun");
